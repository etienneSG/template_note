...
\newcommand\aleaIsProductedPR[2]{\va{x}_{#1}^{#2}}  % 1 if reference #2 is producted at period #1 and 0 otherwise
\newcommand\quantityPR[2]{q_{#1}^{#2}}              % Quantity of reference #2 produced at period #1
\newcommand\aleaQuantityPR[2]{\va{q}_{#1}^{#2}}     % Quantity of reference #2 produced at period #1
\newcommand\stockPR[2]{s_{#1}^{#2}}                 % Stock of reference #2 at the end of period #1
\newcommand\aleaStockPR[2]{\va{s}_{#1}^{#2}}        % Stock of reference #2 at the end of period #1
